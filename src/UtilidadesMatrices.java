...
public class UtilidadesMatrices {
   ...
   //Ejercicio 9
    ...
    public static void main(String args[]){
        ...
        int f[][]=UtilidadesMatrices.arrayBidSuma(d, c);
        int h[]={-2,-5,8,9};
        ...
        System.out.println("El máximo es : "+UtilidadesMatrices.maximo(h));
        System.out.println("El mínimo es : "+UtilidadesMatrices.minimo(h));
        System.out.println("La media es : "+UtilidadesMatrices.mediaArray(b));
        System.out.println(Arrays.toString(UtilidadesMatrices.minimoMaximo(a)));
        System.out.println(Arrays.toString(UtilidadesMatrices.arraySuma(5)));
        System.out.println(UtilidadesMatrices.posicionArray(a, 10));
        System.out.println(Arrays.toString(UtilidadesMatrices.arrayRepetido(a, 5)));
    }
}
